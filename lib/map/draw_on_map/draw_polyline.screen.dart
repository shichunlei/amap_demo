import 'package:amap_demo/utils/next_latlng.dart';
...
class DrawPolylineScreen extends StatefulWidget {
  ...
  @override
  createState() => _DrawPolylineScreenState();
}
          ...
          Flexible(
            child: ListView(children: <Widget>[
              ...
              ListTile(
                  ...
                  onTap: () async {
                    _controller?.zoomToSpan(_pointList, padding: 100);
                  }),
              ListTile(
              ...
              DiscreteSetting(
                  ...
                  onSelected: (value) async {
                    ...
                    await _currentPolyline?.remove();
                    _currentPolyline = await _controller?.addPolyline(
                        PolylineOption(latLngList: [
                      getNextLatLng(),
                      getNextLatLng(),
                      getNextLatLng(),
                      getNextLatLng()
                    ], width: 10, strokeColor: Colors.green, dashType: type));
                  })
            ]),
          )
        ]));
