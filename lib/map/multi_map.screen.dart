              ...
              child: AmapView(
                  ...
                  onMapCreated: (controller) async {
                    if (Platform.isAndroid) {
                      print(
                          '地图1创建完成, id为${controller.androidController.refId}');
                    } else if (Platform.isIOS) {
                      print('地图1创建完成, id为${controller.iosController.refId}');
                    }
          ...
          Flexible(
              child: AmapView(
                  ...
                  onMapCreated: (controller) async {
                    if (Platform.isAndroid) {
                      print(
                          '地图2创建完成, id为${controller.androidController.refId}');
                    } else if (Platform.isIOS) {
                      print('地图2创建完成, id为${controller.iosController.refId}');
                    }
            ...
            child: ListView(children: <Widget>[
              ...
              ListTile(
                  ...
                  onTap: () async {
                    ...
                    print('当前经纬度Extension: ${latLng.toString()}');
                  }),
              ListTile(
